...
FCT_BGN()
{
	FCT_FIXTURE_SUITE_BGN("vec")
	{
		...
		FCT_TEST_BGN("vec3_add")
		{
			...
			fct_chk_eq_dbl(fidx(v3, 0), 4.0f);
			fct_chk_eq_dbl(fidx(v3, 1), 4.0f);
			fct_chk_eq_dbl(fidx(v3, 2), 4.0f);
		}
		FCT_TEST_END();
		...
		FCT_TEST_BGN("vec3_sub")
		{
			...
			fct_chk_eq_dbl(fidx(v3, 1), 0.0f);
			fct_chk_eq_dbl(fidx(v3, 2), 2.0f);
		}
		FCT_TEST_END();
		...
		FCT_TEST_BGN("vec3_neg")
		{
			...
			vec3 v2 = vec3_neg(v1);
			fct_chk_eq_dbl(fidx(v2, 0), -2.0f);
			fct_chk_eq_dbl(fidx(v2, 1), 1.0f);
			fct_chk_eq_dbl(fidx(v2, 2), -3.0f);
		}
		FCT_TEST_END();
		...
		FCT_TEST_BGN("vec3_scale")
		{
			...
			fct_chk_eq_dbl(fidx(v2, 0), 10.0f);
			fct_chk_eq_dbl(fidx(v2, 1), 25.0f);
			fct_chk_eq_dbl(fidx(v2, 2), -5.0f);
		}
		FCT_TEST_END();
